            ...
            <section className='static'>
                ...
                >
                    ...
                    <div className="absolute w-[701.5px] h-[742.7px] left-[513.25px] top-0 bg-[url('/images/Rectangle-2.png')] rounded-[26.1767px]">
                        ...
                        <div className=""><h1 className="w-[614.9px] h-[25px] font-serif-[roboto] font-black text-[25.4118px] leading-[98.69%] items-center flex text-white">Plus qu’une révolution ...</h1>
                        <p className="
